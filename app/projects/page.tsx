...
export const metadata: Metadata = {
  ...
  description:
    "Explore projects built by undergraduate students at Open UG Labs, Makerere University.",
};
      ...
      <section className="border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-8 text-slate-600">
            ...
            explore applied research, and contribute to digital systems that
            matter at Makerere University and beyond.
          </p>
        </div>
      </section>
